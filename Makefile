...
OBJS_EXE = HSLAPixel.o lodepng.o PNG.o main.o KDTree.o stats.o
#OBJS_EXE = HSLAPixel.o lodepng.o PNG.o main.o stats.o
OBJS_EXET = HSLAPixel.o lodepng.o PNG.o testComp.o KDTree.o stats.o
#OBJS_EXET = HSLAPixel.o lodepng.o PNG.o testComp.o stats.o
...
KDTree.o : KDTree.h KDTree.cpp stats.h cs221util/PNG.h cs221util/HSLAPixel.h
	$(CXX) $(CXXFLAGS) KDTree.cpp -o $@

testComp.o : testComp.cpp cs221util/PNG.h cs221util/HSLAPixel.h KDTree.h
	$(CXX) $(CXXFLAGS) testComp.cpp -o testComp.o

main.o : main.cpp cs221util/PNG.h cs221util/HSLAPixel.h KDTree.h
